...
> Άνοιγμα αυτής της σελίδας στο [https://okirioskliklikos.github.io/pxt-robitzero-joystick/](https://okirioskliklikos.github.io/pxt-robitzero-joystick/)
...
* αναζήτηση για **https://github.com/okirioskliklikos/pxt-robitzero-joystick** και εισαγωγή
...
* επικολλήστε **https://github.com/okirioskliklikos/pxt-robitzero-joystick** και κάντε κλικ στην εισαγωγή
